        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(21 * fem, 22 * fem, 13 * fem, 15 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(5 * fem, 15 * fem, 5 * fem, 95 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(
                        0 * fem, 0 * fem, 0 * fem, 198 * fem),
                    padding: EdgeInsets.fromLTRB(
                        19 * fem, 13 * fem, 34 * fem, 12 * fem),
                    width: double.infinity,
                    decoration: BoxDecoration(
                      color: Color(0xffbbc7e7),
                      borderRadius: BorderRadius.circular(50 * fem),

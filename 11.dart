        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(21 * fem, 20 * fem, 74 * fem, 24 * fem),
              width: double.infinity,
              decoration: BoxDecoration(
            ...
            Container(
              ...
              padding:
                  EdgeInsets.fromLTRB(5 * fem, 22 * fem, 5 * fem, 83 * fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                              ...
                              child: RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                      text:
                                          ' Sir, i have completed the duties that are assigned....',
                                      style: TextStyle(
                                        fontFamily: 'Sen',
                                        fontSize: 15 * ffem,
                                        fontWeight: FontWeight.w400,
